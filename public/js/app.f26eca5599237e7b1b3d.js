/*! For license information please see app.f26eca5599237e7b1b3d.js.LICENSE.txt */
"use strict";
  ...
  [143],
  {
    7932: (t, e, r) => {
        ...
        d = y(
          ...
          {},
          {
            characterDetail: function (t) {
              return (0, s.Gn)(m.characterDetail, { id: t });
            },
          }
        ),
        g = r(4900);
        ...
        function S(e, r, n) {
          ...
          return function (i, a) {
            ...
            for (n.method = i, n.arg = a; ; ) {
              ...
              var l = s(e, r, n);
              if ("normal" === l.type) {
                if (((o = n.done ? v : p), l.arg === m)) continue;
                      ...
                      switch ((t.prev = t.next)) {
                        case 0:
                          return (
                            ...
                            _.Z.get(
                              "".concat(
                                process.env.RICK_AND_MORTY_API,
                                "/character"
                              )
                            )
                          );
        ...
        D = function () {
          ...
          return {
            ...
            loadCharacterCollection: function () {
              G().then(function (t) {
                return i(((e = t), (r = T), Array.isArray(e) ? e.map(r) : []));
                var e, r;
              });
            },
          };
          ...
          function (t) {
            ...
            return n.createElement(
              ...
              n.createElement(
                ...
                n.createElement(x.Z, null, n.createElement(U.Z, null))
              )
            );
          });
      function q(t, e) {
            ...
            n.createElement(
              ...
              e.map(function (t) {
                return n.createElement(
                  "li",
                  { key: t.id },
                  n.createElement(V, { character: t, onDetail: r })
                );
              })
            )
          );
      ...
      var mt = function (t) {
        ...
        dt = function () {
          return n.createElement(P, null, n.createElement(mt, null));
        },
        gt = function () {
          return n.createElement(
            l.UT,
            ...
            n.createElement(
              ...
              n.createElement(f.AW, {
                path: m.characterCollection,
                element: n.createElement(tt, null),
              }),
              n.createElement(f.AW, {
                path: m.characterDetail,
                element: n.createElement(dt, null),
              }),
              n.createElement(f.AW, {
                path: m.root,
                element: n.createElement(f.Fg, { to: m.characterCollection }),
              })
            )
          );
        },
